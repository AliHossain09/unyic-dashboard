...
use App\Http\Controllers\View\Size\SizeController;
use App\Http\Controllers\View\Product\ProductController;
use App\Http\Controllers\View\Category\CategoryController;
use App\Http\Controllers\View\Department\DepartmentController;
use App\Http\Controllers\View\Collection\CollectionController;
use App\Http\Controllers\View\SubCategory\SubCategoryController;
...
Route::prefix('popular_categories')->group(function () {
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::delete('/admin/carts/{id}', [CartController::class, 'destroy'])->name('cart.destroy');

    //  This is needed
    Route::get('/wishlists', [wishlistController::class, 'index'])->name('admin.wishlists.index');
    Route::delete('/wishlists/{id}', [WishlistController::class, 'destroy'])->name('wishlist.remove');
});
