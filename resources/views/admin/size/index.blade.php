...
<x-app-layout>
    ...
    {{-- <div class="md:mt-6 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-6xl mx-auto dark:text-white mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        ...
        <!-- Heading -->
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center">Size List</h1>
...
{{-- ...................................................................................................... --}}
  ...
  <div class="md:mt-6 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-7xl mx-auto dark:text-white mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
    ...
    <!-- Heading -->
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center border-b border-gray-200 dark:border-gray-700 pb-2">Size List</h1>

    <!-- Filters: one GET form so search + per_page stay in querystring -->
    <form id="filterForm" method="GET" action="{{ route('sizes.index') }}" class="flex flex-wrap items-center justify-between gap-4 mb-6">
      <!-- Left: Search -->
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          @forelse ($sizes as $size)
            <tr>
              <td class="px-4 py-3">
                <div class="flex items-center gap-2">
                  <input type="checkbox" class="form-checkbox rounded text-indigo-600 export-checkbox" value="{{ $size->id }}">
                  <span class="text-sm text-gray-800 dark:text-gray-200">{{ $loop->iteration + (($sizes->currentPage()-1) * $sizes->perPage()) }}</span>
                </div>
              </td>
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex items-center justify-end gap-2">
                  <a href="{{ route('sizes.edit', $size) }}" class="inline-flex items-center p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <form action="{{ route('sizes.destroy', $size) }}" method="POST" onsubmit="return confirmDelete(event)" class="inline-block">
                    @csrf
                    @method('DELETE')
