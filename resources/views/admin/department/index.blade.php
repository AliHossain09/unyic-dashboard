...
<x-app-layout>
    {{-- <div class="md:mt-6 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-6xl mx-auto dark:text-white mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        ...
        <!-- Heading -->
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center">Department List</h1>
...
{{-- ...................................................................................................... --}}
  ...
  <div class="md:mt-6 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-7xl mx-auto dark:text-white mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
    ...
    <!-- Heading -->
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center border-b border-gray-200 dark:border-gray-700 pb-2">Department List</h1>

    <!-- Filters: one GET form so search + per_page stay in querystring -->
    <form id="filterForm" method="GET" action="{{ route('departments.index') }}" class="flex flex-wrap items-center justify-between gap-4 mb-6">
      <!-- Left: Search -->
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          @forelse ($departments as $department)
            <tr>
              <td class="px-4 py-3">
                <div class="flex items-center gap-2">
                  <input type="checkbox" class="form-checkbox rounded text-indigo-600 export-checkbox" value="{{ $department->id }}">
                  <span class="text-sm text-gray-800 dark:text-gray-200">{{ $loop->iteration + (($departments->currentPage()-1) * $departments->perPage()) }}</span>
                </div>
              </td>
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex items-center justify-end gap-2">
                  <a href="{{ route('departments.edit', $department) }}" class="inline-flex items-center p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <form action="{{ route('departments.destroy', $department) }}" method="POST" onsubmit="return confirmDelete(event)" class="inline-block">
                    @csrf
                    @method('DELETE')
          ...
          <form method="POST" action="{{ route('departments.store') }}">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="name" id="name" required
                class="w-full px-3 py-2 mt-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" />
            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      exportBtn?.addEventListener('click', () => {
        ...
        if(selected.length === 0){
          Swal.fire('No Selection', 'Please select at least one department to export.', 'info');
          return;
        }
