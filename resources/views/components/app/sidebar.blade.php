...
@auth
    @if(Auth::user()->role === 'admin')
        {{-- Admin-only sidebar items go here --}}
        <div class="min-w-fit">
    ...
    <div
    id="sidebar"
    class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 xl:w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out {{ $variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-xs' }}"
    :class="sidebarOpen ? 'max-lg:translate-x-0' : 'max-lg:-translate-x-64', sidebarExpanded ? 'xl:!w-64' : ''"
    @click.outside="sidebarOpen = false"
    @keydown.escape.window="sidebarOpen = false"
>
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                ...
                <h2 class="text-amber-700 text-lg sm:text-xl md:text-sm xl:text-3xl font-bold">Unyic</h2>
            </a>
        </div>
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        ...
                        @endif"
                        x-data="{ open: {{ request()->is('products') || request()->is('products/*') ? 'true' : 'false' }} }">

                        <!-- Parent Item -->
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @unless(request()->is('products') || request()->is('products/*'))
                            ...
                            <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a href="{{ route('products.index') }}"
                                        class="block text-sm font-medium  dark:text-gray-400
                                            ...
                                            @if(request()->routeIs('products.index'))  @endif">
                                        List Products
                                    </a>
                                </li>
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a href="{{ route('products.create') }}"
                                        class="block text-sm font-medium  dark:text-gray-400
                                            hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                            @if(request()->routeIs('products.create')) text-violet-500 @endif">
                                        Add Product
                                    </a>
                                </li>
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a href="{{ route('categories.index') }}"
                                        class="block text-sm font-medium  dark:text-gray-400
                                            hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                            @if(request()->routeIs('categories.index')) text-violet-500 @endif">
                                        Category
                                    </a>
                                </li>
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a href="{{ route('subCategories.index') }}"
                                        class="block text-sm font-medium  dark:text-gray-400
                                            hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                            @if(request()->routeIs('subCategories.index')) text-violet-500 @endif">
                                        Sub Category
                                    </a>
                                </li>
                    ...
                    {{-- <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(in_array(Request::segment(1), ['ecommerce'])){{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['ecommerce']) ? 1 : 0 }} }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <svg shrink-0 fill-current @if(in_array(Request::segment(1), ['ecommerce'])){{ 'text-violet-500' }}@else{{ 'text-gray-400 dark:text-gray-500' }}@endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-plus" viewBox="0 0 16 16">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hidden' }}@endif" :class="open ? 'block!' : 'hidden'">
                                <li class="mb-1 last:mb-0 flex items-center space-x-1">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('orders')){{ 'text-violet-500!' }}@endif" href="{{ route('orders') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Details</span>
                                    </a>
                                </li>
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Order Management</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 @if(in_array(Request::segment(1), ['ecommerce'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hidden' }}@endif" :class="open ? 'block!' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                 ...
                                 <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('orders')){{ 'text-violet-500!' }}@endif" href="{{ route('orders') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Order Place</span>
                                    </a>
                                </li>
                                {{-- <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('invoices')){{ 'text-violet-500!' }}@endif" href="{{ route('invoices') }}">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('departments') || request()->is('departments/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('departments') || request()->is('departments/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('departments') && !request()->is('departments/*'))
                                    hover:text-gray-900 dark:hover:text-white
                    ...
                    <div class="flex items-center">
                        <svg class="shrink-0 fill-current
                                ...
                                @else
                                    text-gray-400 dark:text-gray-500
                                @endif"
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid" viewBox="0 0 16 16">
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('departments.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('departments.create')) text-violet-500 @endif">
                            Add Department
                        </a>
                    </li>
                        ...
                        <li class="mb-1 last:mb-0">
                            <a href="{{ route('departments.index') }}"
                                class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                    hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                    @if(request()->routeIs('departments.index')) text-violet-500 @endif">
                                List Department
                            </a>
                        </li>
                    </ul>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('categories') || request()->is('categories/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('categories') || request()->is('categories/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('categories') && !request()->is('categories/*'))
                                    hover:text-gray-900 dark:hover:text-white
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('categories.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('categories.create')) text-violet-500 @endif">
                            Add Category
                        </a>
                    </li>
        ...
        {{-- Category End --}}
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('subCategories') || request()->is('subCategories/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('subCategories') || request()->is('subCategories/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('subCategories') && !request()->is('subCategories/*'))
                                    hover:text-gray-900 dark:hover:text-white
                    ...
                    <div class="flex items-center">
                        <svg class="shrink-0 fill-current
                                ...
                                @else
                                    text-gray-400 dark:text-gray-500
                                @endif"
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid-1x2" viewBox="0 0 16 16">
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('subCategories.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('subCategories.create')) text-violet-500 @endif">
                            Add Sub Category
                        </a>
                    </li>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('sizes') || request()->is('sizes/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('sizes') || request()->is('sizes/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('sizes') && !request()->is('sizes/*'))
                                    hover:text-gray-900 dark:hover:text-white
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('sizes.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('sizes.create')) text-violet-500 @endif">
                            Add Size
                        </a>
                    </li>
                        ...
                        <li class="mb-1 last:mb-0">
                            <a href="{{ route('sizes.index') }}"
                                class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                    hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                    @if(request()->routeIs('sizes.index')) text-violet-500 @endif">
                                List Size
                            </a>
                        </li>
                    </ul>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('collections') || request()->is('collections/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('collections') || request()->is('collections/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('collections') && !request()->is('collections/*'))
                                    hover:text-gray-900 dark:hover:text-white
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('collections.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('collections.create')) text-violet-500 @endif">
                            Add Collection
                        </a>
                    </li>
                        ...
                        <li class="mb-1 last:mb-0">
                            <a href="{{ route('collections.index') }}"
                                class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                    hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                    @if(request()->routeIs('collections.index')) text-violet-500 @endif">
                                List Collection
                            </a>
                        </li>
                    </ul>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
                        @if(request()->is('banners') || request()->is('banners/*'))
                            from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
                        @endif"
                    x-data="{ open: {{ request()->is('banners') || request()->is('banners/*') ? 'true' : 'false' }} }">
                        <a href="#0"
                            class="block text-gray-800 dark:text-gray-100 truncate transition
                                @if(!request()->is('banners') && !request()->is('banners/*'))
                                    hover:text-gray-900 dark:hover:text-white
                ...
                <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
                    ...
                    <li class="mb-1 last:mb-0">
                        <a href="{{ route('banners.create') }}"
                            class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                @if(request()->routeIs('banners.create')) text-violet-500 @endif">
                            Add Banner
                        </a>
                    </li>
                        ...
                        <li class="mb-1 last:mb-0">
                            <a href="{{ route('banners.index') }}"
                                class="block text-sm font-medium text-gray-500/90 dark:text-gray-400
                                    hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                                    @if(request()->routeIs('banners.index')) text-violet-500 @endif">
                                List Banner
                            </a>
                        </li>
                    </ul>
...
<li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
    @if(request()->is('popular_categories') || request()->is('popular_categories/*'))
        from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
    @endif"
x-data="{ open: {{ request()->routeIs('popular_categories.*') ? 'true' : 'false' }} }">
    <a href="#0"
       class="block text-gray-800 dark:text-gray-100 truncate transition
           @if(!request()->routeIs('popular_categories.*')) hover:text-gray-900 dark:hover:text-white @endif"
       @click.prevent="open = !open; sidebarExpanded = true">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <svg class="shrink-0 fill-current
                    @if(request()->routeIs('popular_categories.*')) text-violet-500 @else text-gray-400 dark:text-gray-500 @endif"
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-star" viewBox="0 0 16 16">
                    <path d="M8 12.146l-3.717 1.95.71-4.142L2 6.765l4.17-.606L8 2.5l1.83 3.659 4.17.606-3.01 2.189.71 4.142L8 12.146z"/>
                </svg>
                <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                    Popular Category
                </span>
        ...
        <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
            <li class="mb-1 last:mb-0">
                <a href="{{ route('popular_categories.create') }}"
                   class="block text-sm font-medium text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                   @if(request()->routeIs('popular_categories.create')) text-violet-500 @endif">
                   Add Popular Category
                </a>
            </li>
            <li class="mb-1 last:mb-0">
                <a href="{{ route('popular_categories.index') }}"
                   class="block text-sm font-medium text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate
                   @if(request()->routeIs('popular_categories.index')) text-violet-500 @endif">
...
{{-- Popular Category End --}}
                    ...
                    {{-- Wishlist Start --}}
<li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
    @if(request()->is('wishlists') || request()->is('wishlists/*'))
        from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
    @endif"
x-data="{ open: {{ request()->is('wishlists') || request()->is('wishlists/*') ? 'true' : 'false' }} }">
    <a href="#0"
       class="block text-gray-800 dark:text-gray-100 truncate transition"
       @click.prevent="open = !open; sidebarExpanded = true">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-4">Wishlist</span>
            </div>
            <div>
                <svg class="w-3 h-3 fill-current text-gray-400 dark:text-gray-500"
                     :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                    <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"/>
                </svg>
            </div>
    ...
    <div class="lg:hidden lg:sidebar-expanded:block">
        <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
            <li>
                <a href="{{ route('admin.wishlists.index') }}" class="block text-sm font-medium text-gray-500 hover:text-violet-500">
                    List Wishlists
                </a>
            </li>
        </ul>
...
{{-- Cart Start --}}
<li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r
    @if(request()->is('carts') || request()->is('carts/*'))
        from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]
    @endif"
x-data="{ open: {{ request()->is('carts') || request()->is('carts/*') ? 'true' : 'false' }} }">
    <a href="#0"
       class="block text-gray-800 dark:text-gray-100 truncate transition"
       @click.prevent="open = !open; sidebarExpanded = true">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <svg class="shrink-0 fill-current
                    ...
                    @endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    viewBox="0 0 24 24" fill="currentColor">
                    <path d="M7 4h-2l-3 7v2h2l3-7zm-3.35 11a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm13.7 0a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm-10.35-6h12l1.25 5h-14.5l1.25-5z"/>
                </svg>
                <span class="text-sm font-medium ml-4">Cart</span>
            </div>
            <div>
                <svg class="w-3 h-3 fill-current text-gray-400 dark:text-gray-500"
                     :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
    ...
    <div class="lg:hidden lg:sidebar-expanded:block">
        <ul class="pl-8 mt-1" :class="open ? 'block' : 'hidden'">
            <li>
                <a href="{{ route('admin.carts.index') }}" class="block text-sm font-medium text-gray-500 hover:text-violet-500">
                    List Carts
                </a>
            </li>
        </ul>
...
{{-- Cart End --}}
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(in_array(Request::segment(1), ['ecommerce'])){{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['ecommerce']) ? 1 : 0 }} }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Invoice</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 @if(in_array(Request::segment(1), ['ecommerce'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hidden' }}@endif" :class="open ? 'block!' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('orders')){{ 'text-violet-500!' }}@endif" href="{{ route('orders') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Preview</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('invoices')){{ 'text-violet-500!' }}@endif" href="{{ route('invoices') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Edit</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('invoices')){{ 'text-violet-500!' }}@endif" href="{{ route('invoices') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Add</span>
                                    </a>
                                </li>
        ...
        <div class="mt-6 border-t-3 border-black border-dashed">
                    <p class="mb-1 pt-3 hidden md:block text-balance text-xs">------- Copyright @2025 -------</p>
                    <span class="text-sm">Powered by : </span> <span class="text-sm">ALI HOSSAIN</span>
                </div>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if(in_array(Request::segment(1), ['ecommerce'])){{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['ecommerce']) ? 1 : 0 }} }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Product</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 @if(in_array(Request::segment(1), ['ecommerce'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hidden' }}@endif" :class="open ? 'block!' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('invoices')){{ 'text-violet-500!' }}@endif" href="{{ route('invoices') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sub Category</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Wishlist</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 @if(in_array(Request::segment(1), ['ecommerce'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Cart</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 @if(in_array(Request::segment(1), ['ecommerce'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
