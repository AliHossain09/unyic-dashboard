...
const ImageZoomer = ({ imageSrc, imageAlt = "" }: ImageZoomerProps) => {
  ...
  return (
    <div
      ...
      className="w-full product-image-ratio relative"
    >
      <img ref={imageRef} src={imageSrc} alt={imageAlt} className="size-full" />
      ...
      <div
        className={clsx(
          "absolute top-0 left-[calc(100%+8px)] w-4/7 h-full",
